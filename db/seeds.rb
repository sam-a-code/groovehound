...
puts '🌙 Seeding users...'
u1 = User.create(username: "Nico123", email: "nico123@gmail.com", password:"password", first_name: "Nico", last_name: "123", favorite_band: "Bruce Springsteen & The E Street Band", location: "NJ", genre_1: "Indie", genre_2: "Rock", genre_3: "Alternative")
u2 = User.create(username: "Tyler123", email: "tyler123@gmail.com", password:"password", first_name: "Tyler", last_name: "123", favorite_band: "The Beatles", location: "PA", genre_1: "Pop", genre_2: "Rock", genre_3: "n Roll")
u3 = User.create(username: "Sam123", email: "sam123@gmail.com", password:"password", first_name: "Sam", last_name: "123", favorite_band: "The Beatles", location: "IL", genre_1: "Pop", genre_2: "Rock", genre_3: "n Roll")
u4 = User.create(username: "Willa123", email: "willa123@gmail.com", password:"password", first_name: "Willa", last_name: "123", favorite_band: "The Beatles", location: "NJ", genre_1: "Pop", genre_2: "Rock", genre_3: "n Roll")
...
c2 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2015-08-09".to_datetime, user_id: u2.id, venue_id: v2.id, band_id: b2.id)
...
c4 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2015-08-08".to_datetime, user_id: u3.id, venue_id: v4.id, band_id: b4.id)
c5 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-11-20".to_datetime, user_id: u4.id, venue_id: v5.id, band_id: b5.id)
c6 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-11-22".to_datetime, user_id: u2.id, venue_id: v6.id, band_id: b6.id)
c7 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-02-22".to_datetime, user_id: u3.id, venue_id: v7.id, band_id: b7.id)
c8 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-11-25".to_datetime, user_id: u1.id, venue_id: v8.id, band_id: b8.id)
c9 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-03-05".to_datetime, user_id: u1.id, venue_id: v9.id, band_id: b9.id)
c10 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-11-29".to_datetime, user_id: u4.id, venue_id: v10.id, band_id: b10.id)
c11 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-11-30".to_datetime, user_id: u3.id, venue_id: v11.id, band_id: b11.id)
c12 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-12-01".to_datetime, user_id: u2.id, venue_id: v12.id, band_id: b12.id)
c13 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-12-05".to_datetime, user_id: u1.id, venue_id: v13.id, band_id: b13.id)
c14 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-12-07".to_datetime, user_id: u4.id, venue_id: v14.id, band_id: b14.id)
c15 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-12-10".to_datetime, user_id: u3.id, venue_id: v15.id, band_id: b15.id)
c16 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-12-14".to_datetime, user_id: u2.id, venue_id: v16.id, band_id: b16.id)
c17 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-12-16".to_datetime, user_id: u3.id, venue_id: v17.id, band_id: b17.id)
c18 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-12-18".to_datetime, user_id: u4.id, venue_id: v18.id, band_id: b18.id)
c19 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-12-20".to_datetime, user_id: u1.id, venue_id: v1.id, band_id: b19.id)
c20 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2022-12-23".to_datetime, user_id: u2.id, venue_id: v2.id, band_id: b20.id)
c21 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-01-01".to_datetime, user_id: u3.id, venue_id: v3.id, band_id: b21.id)
c22 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-01-10".to_datetime, user_id: u4.id, venue_id: v4.id, band_id: b22.id)
c23 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-01-12".to_datetime, user_id: u1.id, venue_id: v5.id, band_id: b23.id)
c24 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-01-18".to_datetime, user_id: u2.id, venue_id: v6.id, band_id: b24.id)
c25 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-01-25".to_datetime, user_id: u3.id, venue_id: v7.id, band_id: b25.id)
c26 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-02-02".to_datetime, user_id: u4.id, venue_id: v8.id, band_id: b26.id)
c27 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-02-04".to_datetime, user_id: u1.id, venue_id: v9.id, band_id: b27.id)
c28 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-02-12".to_datetime, user_id: u2.id, venue_id: v10.id, band_id: b28.id)
c29 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-02-19".to_datetime, user_id: u3.id, venue_id: v11.id, band_id: b29.id)
c30 = Concert.create(comment: "NA", tickets_remaining: 5, link: "http://www.eventbrite.com", date: "2023-02-25".to_datetime, user_id: u4.id, venue_id: v12.id, band_id: b30.id)
